  ...
  return (
    <section aria-labelledby="compare-heading">
      <PageHeader
        ...
        eyebrow="Analysis mode comparison"
        title="Compare"
        description={
          <>
            Compare two analysis modes over the same filters and published time range. Analysis
            excludes exact <code>invalid - norisk</code>; AI Analysis excludes exact{" "}
