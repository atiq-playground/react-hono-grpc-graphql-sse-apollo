...
const OWNER_NAME = "Atiq Rahman";
const OWNER_EMAIL = "hi@atiqrahman.work";
const GITHUB_URL = "https://github.com/noonii";
const LINKEDIN_URL = "https://www.linkedin.com/in/atiq-r";
const PORTFOLIO_URL =
